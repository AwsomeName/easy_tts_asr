...
class CommonVoice(datasets.GeneratorBasedBuilder):
    ...
    def _split_generators(self, dl_manager):
        ...
        base_data_path = "/home/lc/data_a/mozilla-foundation/common_voice_11_0/"
        archive_paths = {}
        for split in splits:
            archive_paths[split] = []
            for i in range(n_shards[lang][split]):
                file_path_name = base_data_path +  "audio/" + lang + "/" + split + "/" 
                file_name = lang + "_" + split + "_" + str(i) + ".tar"
                archive_paths[split].append(file_path_name + file_name)
        ...
        for split in splits:
            file_name = base_data_path + "transcript/" + lang + "/" + split + ".tsv"
            meta_paths[split] = file_name
